...
The nice thing about this is that it's officially supported by Google, which isn't going to change anytime soon.
...
- I wanted to add a custom 404 page, but I would need to move off GitHub pages and set up my own server for that.
